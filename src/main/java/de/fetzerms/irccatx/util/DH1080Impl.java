 ...
 * @version $Id$
 */
public class DH1080Impl {

    public static final String DH1080_FINISH = "DH1080_FINISH";
    public static final String DH1080_INIT = "DH1080_INIT";

    private static final Logger logger = Logger.getLogger(DH1080Impl.class);
